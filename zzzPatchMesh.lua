zzzPatchMesh = {}
local enforce = true
-- zzzPatchMesh.onceaftersometime = true
-- zzzPatchMesh.timerdefault = 0
function zzzPatchMesh.applyMesh()
	-- Cities ARR
	...
	ml_mesh_mgr.SetDefaultMesh(161, "[KDF] - Copperbell Mines", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(189, "[KDF] - Amdapor Keep (Hard)", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(516, "[KDF] - The Antitower", enforce)
	--ml_mesh_mgr.SetDefaultMesh(???, "[Dungeon] The Lost City of AmdaporHM", enforce)
	ml_mesh_mgr.SetDefaultMesh(555, "[KDF] - Sohr Khai", enforce)
	--ml_mesh_mgr.SetDefaultMesh(???, "[Dungeon] Hullbreaker IsleHM", enforce)
	ml_mesh_mgr.SetDefaultMesh(572, "[KDF] - Xelphatol", enforce)
	--ml_mesh_mgr.SetDefaultMesh(???, "[Dungeon] The Great Gubal LibraryHM", enforce)
	ml_mesh_mgr.SetDefaultMesh(615, "[KDF] - Baelsar's Wall", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(689, "[KDF] - Ala Mhigo", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(768, "[KDF] - The Swallow's Compass", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(922, "[KDF] - The Seat of Sacrifice", enforce)
	...
	ml_mesh_mgr.SetDefaultMesh(897, "[KDF] - Cinder Drift", enforce)
...
function zzzPatchMesh.ModuleInit()
	zzzPatchMesh.applyMesh()
end

RegisterEventHandler("Module.Initalize",zzzPatchMesh.ModuleInit, "zzzPatchMesh")		